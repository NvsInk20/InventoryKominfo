        ...
        <div class="min-h-screen bg-gray-100 p-0 sm:p-12 -mt-10">
            <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
                ...
                <div class="flex flex-row space-x-4 mt-5">
                    <div class="relative z-0 w-full mb-5">
                        <!-- Input tanggal dengan properti onclick untuk mengubah tipe ke date -->
                        ...
                        <label for="tanggal_peminjaman"
                            class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Tanggal
                            Peminjaman</label>
                        {{-- <span class="text-sm text-red-600 hidden" id="error">Tolong isi tanggal peminjaman
                            terlebih
                            dahulu</span> --}}
                    </div>
                </div>
